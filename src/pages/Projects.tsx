...
const projects = [
  ...
  },
  {
    id: 'course-tools',
    title: 'Course Tools',
    description: 'A collection of helpful calculators and utilities for academic courses including linear algebra, calculus, chemistry, vector math, proofs, and CS tools. (In Progress)',
